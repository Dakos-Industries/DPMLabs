...
public class Odometer extends Thread {
	...
	private int oldLeftTachoCount, oldRightTachoCount;
	...
	public void run() {
		...
		oldLeftTachoCount = leftMotor.getTachoCount();
	    oldRightTachoCount = rightMotor.getTachoCount();
		...
		while (true) {
			...
			synchronized (lock) {
				...
				distL = 3.14159*Lab2.WHEEL_RADIUS*(leftMotorTachoCount- oldLeftTachoCount)/180;		// compute L and R wheel displacements
				distR = 3.14159*Lab2.WHEEL_RADIUS*(rightMotorTachoCount- oldRightTachoCount)/180;
				oldLeftTachoCount = leftMotorTachoCount;								// save tacho counts for next iteration
